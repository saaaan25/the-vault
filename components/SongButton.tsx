...
const SongButton: React.FC<SongButtonProps> = ({ playlists = [], data }) => {
    ...
    const triggerEspecific = (
        <button className="flex items-center w-full px-2 py-2 mr-2 hover-bg-custom-color-5 rounded-md">
    ...
    const contentGeneral = (
        <div>
            ...
            <div>
                <button
                className="flex items-center w-full px-2 py-2 mr-2 hover-bg-custom-color-5 rounded-md"
